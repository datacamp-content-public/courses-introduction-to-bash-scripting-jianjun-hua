...
`@script`
Let's combine what we just learned about break and continue. In this example, we want to loop over 1 to 20 but skip 1 to 4 using continue and break out the loop when the loop index is greater than 15. Check this out! Does it make sense to you? Let's see if we get what we expected! 
